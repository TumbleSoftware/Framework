<?php
  ...
  $segment->add_text_input('user_username','user-username','Admin','Admin Name','','Admin Username', $tooltip, $validate);
  ...
  $segment->add_password_input('user_password','user-password','','Admin Password','','Admin Password', $tooltip, $validate);
  ...
  $validate->required_var = true;
  $segment->add_password_input('confirm','confirm-password','','Confirm Password','','Confirm Password', $tooltip, $validate);
  ...
  $segment->add_text_input('user_email','user-email','','Admin E-Mail','','Admin E-Mail', $tooltip, $validate);
  ...
  $validate = null;
  $segment2->add_checkbox_input('email_details', 'email-details', '', 'E-Mail Details','', 'E-Mail Details',$tooltip, $validate);
